# Silahkan buat kode css dengan menggunakan property pada materi yang telah dipelajari (wajib menggunakan property flex-flow) sehingga hasilnya akan seperti gambar dibawah ini:
